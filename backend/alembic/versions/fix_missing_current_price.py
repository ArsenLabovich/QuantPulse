...
Revision ID: fix_missing_current_price
Revises: db8e60ffd7f6
Create Date: 2026-02-03 21:10:00.000000
...
revision: str = 'fix_missing_current_price'
...
def upgrade() -> None:
    # Add missing 'current_price' column which caused 500 errors on prod
