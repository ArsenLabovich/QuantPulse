"""Database models for financial assets and portfolio snapshots."""
...
class UnifiedAsset(Base):
    ...
    usd_value = Column(Numeric(precision=30, scale=8), nullable=True)  # Converted value in base currency (USD)
