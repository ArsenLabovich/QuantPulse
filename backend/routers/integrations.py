"""API endpoints for managing brokerage and exchange integrations."""
...
async def create_integration(
    ...
    try:
        ...
        is_valid = await adapter.validate_credentials(integration_in.credentials, integration_in.settings)
        if not is_valid:
            raise HTTPException(
                status_code=400,
